...
| **Dark mode** + appearance controls in Settings → Display & Kiosk (Light / Dark / Match system / Follow the sun) | ✅ | 🔜 | 🔜 | 🟡 Web/kiosk done; iOS parity planned (`apps/ios/DARK_MODE.md`) |
